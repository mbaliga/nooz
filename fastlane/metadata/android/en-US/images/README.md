...
- `featureGraphic.png` — present (1024×500, Play only, opaque RGB — no alpha):
  plain paperField background, the "Nooz" wordmark in Hyle Print Medium, and
  the short_description.txt tagline beneath it in Hyle Grotesk Classic —
  ...
  Bundled fonts only, no external asset.
